...
pub fn ensure_loaded(ctx: &egui::Context, sheets: &mut Vec<SpriteSheet>, settings: &Settings) {
    ...
    let png_paths = crate::global::get(&base_dir, &["img015.png"], &settings.general.language_priority);
    let cut_paths = crate::global::get(&base_dir, &["img015.imgcut"], &settings.general.language_priority);
